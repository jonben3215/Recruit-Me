...
const server = createServer((req, res) => {
  ...
  const targetURL = `${config.BASE_URL}/${country.toLowerCase()}/${config.BASE_PARAMS}&app_id=${'0ccca982'}&app_key=${'2c16edcafe59677615b5996af2978dbd'}&what=${search}&where=${location}`;
    if (req.method === 'GET') {
